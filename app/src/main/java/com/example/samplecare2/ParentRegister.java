...
public class ParentRegister extends AppCompatActivity {
    ...
    private final Observer<Boolean> permissionObserver = new Observer<Boolean>() {
        ...
        public void onChanged(Boolean isGranted) {
            if (isGranted) {
                ...
                Toast.makeText(ParentRegister.this, "Permission denied", Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageViews.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(ParentRegister.this, android.Manifest.permission.READ_EXTERNAL_STORAGE)
    ...
    private void registerUser() {
        ...
        String parentId = databaseReference.push().getKey();
        String imageUri = "images/" + parentId + ".jpg"; // Example path for storing images in Firebase Storage
        // Store the image in Firebase Storage (e.g., using Firebase Storage SDK)

        Parent user = new Parent(parentId, fullName, city, email, password, imageUri);
        ...
        builder.setPositiveButton("Accept", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                databaseReference.child(parentId).setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {

                        if (task.isSuccessful()) {

                            Toast.makeText(ParentRegister.this, "Parent registered successfully", Toast.LENGTH_SHORT).show();
                            clearFields();
                            launchParentLoginScreen();


                        } else {
                            Toast.makeText(ParentRegister.this, "Failed to register user", Toast.LENGTH_SHORT).show();
    ...
    {
        Intent intent1 = new Intent(ParentRegister.this, ParentLoginActivity.class);
